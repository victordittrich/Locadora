            ...
            <thead>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <a class="btn btn-warning btn-sm" style="color:#fff" role="button" href="editar_carro.php?carro=<?php echo $id  ?>">Editar</a> 
                        <a class="btn btn-danger btn-sm" style="color:#fff" role="button" href="deletar_carro.php?carro=<?php echo $id ?>">Deletar</a>
